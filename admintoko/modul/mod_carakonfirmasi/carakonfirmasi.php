...
$aksi="modul/mod_carakonfirmasi/aksi_carakonfirmasi.php";
switch($_GET[act]){
  ...
  default:
    ...
    echo "<h2>Edit Panduan Cara Konfirmasi</h2>
          <form method=POST action=$aksi?module=carakonfirmasi&act=update>
